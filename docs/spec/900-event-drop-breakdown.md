...
> 来源：I 会话第 1 轮 = effort #900（[T1251](../../.wayfinder/tickets/T1051-event-drop-breakdown-shape.md) / [T1252](../../.wayfinder/tickets/T1252-event-drop-breakdown-verify.md) / impl 653）。借鉴：Sentry [discarded events](https://getsentry.github.io/sentry-relays/)——丢弃不只给总量，按 reason 分维可查询，"为什么丢"一读即知。

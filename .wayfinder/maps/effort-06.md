...
> effort #6，延续 [effort #1](effort-01.md)（#1）、[effort #2](effort-02.md)（#2）、[effort #3](effort-03.md)（#3）、[effort #4](effort-04.md)（#4）、[effort #5](effort-05.md)（#5：韧性/成本/工具面/会话/基建 22 轮，T81–T102，impl 56–77）。
...
- **tracker 约定**：见 [README.md](readme-effort-06.md)；票号 T103 起全局续用；impl 切片 78 起续用。

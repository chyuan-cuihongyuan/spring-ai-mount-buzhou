...
| 8 | outbox 投递批量 AIMD 自适应（指标标签值集守卫 ruled-out——TagCardinalityGuard spec 132 运行时守卫已覆盖） | TCP AIMD（RFC 5681） | T1265–T1266 | 660 | 907 | ✅ README 行欠账（906+907 两行，J 会话 README 竞争解除后补） |
| 9 | （开工时按缺口核查选题，候选见下） | — | T1267–T1268 | 661 | 908 |  |

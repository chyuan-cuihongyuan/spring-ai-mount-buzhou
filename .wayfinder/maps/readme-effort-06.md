> **历史存档**：以下为 effort #6 运行期的 tracker 约定（当时每个 effort 一个独立目录 `.wayfinder6/`）。
> 2026-08-17 起全部 effort 融合为单一 `.wayfinder/`：map → `maps/effort-06.md`，决策票 → `../tickets/`，实现切片 → `../impl/`，现行约定见 [`../README.md`](../README.md)。

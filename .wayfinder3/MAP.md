...
> effort #3，延续 [`.wayfinder/`](../.wayfinder/MAP.md)（#1：Tier-1 落地）与 [`.wayfinder2/`](../.wayfinder2/MAP.md)（#2：Tier-2/3 全量 + 27 切片落地）。
...
- **tracker 约定**：见 [`.wayfinder3/README.md`](README.md)；票号 T55 起全局续用。

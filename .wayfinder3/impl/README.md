...
| # | 切片 | Blocked by | 状态 |
|---|------|-----------|------|
| 28 | core · Turn Deadline 贯穿 + 挂起免疫 + 故障注入构件 | — | ready |
| 29 | 横切 · 异常分类体系 + 错误码 + 日志基线 | — | ready |
| 30 | core · 优雅停机与生命周期 | 28 | ready |
| 31 | stores · Schema 版本化迁移 + MySQL 幂等 + 恢复设施装配 | — | ready |
| 32 | stores · 事务接线 + 并发正确性 + 降级语义 | 31 | ready |
| 33 | core · 租约续租 + LeaseLost + 写路径 fence | 28, 29 | done |
| 34 | core · 事件背压 + 线程卫生 | 29 | ready |
| 35 | 横切 · deleteSession 级联清理 + SessionCleaner | 31 | ready |
| 36 | stores · InMemory 有界化 + 容量配额 | 29, 35 | ready |

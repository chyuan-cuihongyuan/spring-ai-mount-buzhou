...
| 过程治理 | R 系 R18 周期对账 | Wave 3 五新类型快照补登（1138→1143：区块剪枝/尺寸分层合并/Bitcask 键目录/Slab 装箱/HNSW——cleanup×3+cache×1+memory×1 三段）+ 全仓 16 模块离线 verify 三门绿（R 第三波——对账门十八号四件套齐整）+ 18/50=36% 里程碑（spec 4017） | [spec 4017](docs/spec/4017-r-r18-reconciliation.md) |

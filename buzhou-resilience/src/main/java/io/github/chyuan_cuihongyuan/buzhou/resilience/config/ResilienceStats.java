...
public final class ResilienceStats implements BuzhouHealth {
    ...
    /** spec 638 / T924：生效限流后端标识（configure 时一次性写入）。 */
    ...
    public Map<String, Object> details() {
        ...
        details.put("rateLimitBackend", rateLimitBackend); // spec 638：memory/memory-gcra/redis 一读便知
    ...
    /** spec 638：生效限流后端标识（configure 时设置——health details 直读）。 */

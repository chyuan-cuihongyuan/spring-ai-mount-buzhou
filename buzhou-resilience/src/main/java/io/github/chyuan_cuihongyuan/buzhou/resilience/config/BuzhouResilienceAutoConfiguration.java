 ...
 * {@code ResilienceAdvisor} 注入 advisor 链最内层。
 */
@AutoConfiguration
...
public class BuzhouResilienceAutoConfiguration {
    ...
    @Bean
    public RuntimeConfig resilienceRuntimeConfig(ResilienceProperties properties) {
        return ResilienceModule.configure(properties);
    }
}

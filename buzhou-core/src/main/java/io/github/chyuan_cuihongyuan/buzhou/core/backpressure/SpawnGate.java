...
public final class SpawnGate {
     ...
     * @throws io.github.chyuan_cuihongyuan.buzhou.core.session.RuntimeDrainingException 排队期间 drain 置位
     */
    public void acquireSlotOrThrow(String sessionId) {
        if (policy == OverloadPolicy.FAIL_FAST) {
            ...
            if (draining) {
                ...
                throw new io.github.chyuan_cuihongyuan.buzhou.core.session.RuntimeDrainingException(sessionId);
            }
            return;
        }
     ...
     * 被唤醒的等待者重新检查 {@code draining} 标志后抛 {@link io.github.chyuan_cuihongyuan.buzhou.core.session.RuntimeDrainingException}。
     */

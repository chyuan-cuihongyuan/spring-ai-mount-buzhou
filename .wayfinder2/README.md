...
本目录是**第二个 effort** 的 wayfinder 图，延续 [`.wayfinder/`](../.wayfinder/README.md)（effort #1「core 做深做透」，T1–T27 已闭合，仅 T10 HITL/环境遗留）。**map = `MAP.md`**；**决策票 = `tickets/T<n>-<slug>.md`**（编号 **T28 起全局续用**，避免与 effort #1 的 T1–T27 歧义）。
